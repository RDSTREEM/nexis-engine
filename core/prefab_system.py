...
class PrefabSystem:
    ...
    def save_prefab(self, entity: "Entity", path: Optional[Path] = None) -> Path:
        """
        ...
        if path is None:
            prefabs_dir = (
                (self.app.project.project_root or Path(".")) / "assets" / "prefabs"
            )
    ...
    def instantiate(
        ...
        self.app.console.info(f"Instantiated prefab '{path.stem}' as '{entity.name}'")
        return entity
    ...
    def _apply_overrides(self, entity: "Entity", overrides: Dict[str, Any]) -> None:
